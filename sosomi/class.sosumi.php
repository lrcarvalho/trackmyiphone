<?PHP
    ...
    class Sosumi
    {
        ...
        public function locate($device_num = 0, $max_wait = 300, $force_update_devices = true)
        {
            $start = time();
            
            /**
             Force new request to server. In ase off this vars are alread set, 
             this function will not return current location.
            **/ 
            if ($force_update_devices == true) 
            {
                $this->devices[$device_num]->latitude = null;
                $this->devices[$device_num]->longitude = null;    
            }
